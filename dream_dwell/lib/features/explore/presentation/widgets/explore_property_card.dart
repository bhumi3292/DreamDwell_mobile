...
class _ExplorePropertyCardState extends State<ExplorePropertyCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final hasImages = widget.property.images != null && widget.property.images!.isNotEmpty;
    final hasVideos = widget.property.videos != null && widget.property.videos!.isNotEmpty;
                        ...
                        children: [
                          ...
                          PageView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final isVideo = hasVideos && widget.property.videos!.contains(mediaUrl);
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: isVideo
                                        ...
                                        : Image.network(
                                            ImageUrlHelper.constructImageUrl(mediaUrl),
                                            fit: BoxFit.cover,
                    ...
                    children: [
                      ...
                      BlocBuilder<CartBloc, CartState>(
                        builder: (context, cartState) {
                          ...
                          if (cartState is CartLoaded && widget.property.id != null) {
                            isFavorite = cartState.cart.items?.any((item) => item.property.id == widget.property.id) ?? false;
                          }
                            ...
                            child: IconButton(
                              ...
                              onPressed: () {
                                if (widget.property.id != null && !isFavorite) {
                                  context.read<CartBloc>().add(AddToCartEvent(widget.property.id!));
                                }
                              },
                            ),
                          );
