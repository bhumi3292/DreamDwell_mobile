...
import 'package:dream_dwell/app/constant/network_utils.dart';
  ...
  Future<void> _testConnection() async {
    ...
    try {
      final socket = await Socket.connect(
        InternetAddress(ApiEndpoints.serverAddress.replaceAll('http://', '').replaceAll(':3001', '')),
        3001,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    SelectableText('Server Address: ${ApiEndpoints.serverAddress}'),
                    SelectableText('Base URL: ${ApiEndpoints.baseUrl}'),
                    SelectableText('Real Device Address: ${ApiEndpoints.realDeviceAddress}'),
                  ],
                ),
              ),
            ),
