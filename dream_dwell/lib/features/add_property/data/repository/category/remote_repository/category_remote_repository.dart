...
class CategoryRemoteRepository implements ICategoryRepository {
  ...
  Future<Either<Failure, void>> addCategory(CategoryEntity category) async {
    try {
      ...
      return Left(RemoteDatabaseFailure(message: 'Failed to add category remotely: ${e.toString()}'));
    }
  }
  ...
  Future<Either<Failure, void>> deleteCategory(String categoryId) async {
    try {
      ...
      return Left(RemoteDatabaseFailure(message: 'Failed to delete category remotely: ${e.toString()}'));
    }
  }
  ...
  Future<Either<Failure, void>> updateCategory(CategoryEntity category) async {
    try {
      ...
      return Left(RemoteDatabaseFailure(message: 'Failed to update category remotely: ${e.toString()}'));
    }
  }
}