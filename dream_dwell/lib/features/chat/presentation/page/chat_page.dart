...
import 'package:dream_dwell/features/chat/data/model/chat_message_model.dart';
      ...
      builder: (context, state) {
        ...
        if (state is ChatsLoading) {
          ...
          if (chats.isEmpty) {
            ...
            return const Center(child: Text('No chats found.', style: TextStyle(fontSize: 18, color: Colors.grey)));
          }
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              final participants = (chat['participants'] as List?)?.where((p) => p['_id'] != currentUserId).toList() ?? [];
              final chatName = participants.isNotEmpty
              ...
              final lastMessageAt = chat['lastMessageAt'] != null
                  ...
                  : null;
              final avatarUrl = participants.isNotEmpty ? participants.first['profilePicture'] : null;
              print('[DEBUG] ChatList item: chatId=$chatId, chatName=$chatName, lastMessage=$lastMessage');
              return Card(
                color: Colors.white,
                elevation: 2,
                ...
                child: ListTile(
                  ...
                  leading: avatarUrl != null
                      ...
                      : CircleAvatar(
                          ...
                          radius: 24,
                          child: Text(chatName.isNotEmpty ? chatName[0] : '?', style: const TextStyle(fontSize: 20, color: Colors.black)),
                        ),
                  title: Text(chatName, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                  subtitle: Text(
                    lastMessage.isNotEmpty ? lastMessage : 'No messages yet.',
                    style: TextStyle(
                      color: lastMessage.isNotEmpty ? Colors.grey[700] : Colors.grey[400],
          ...
          print('[DEBUG] ChatList received ChatLoaded state, dispatching LoadMyChats');
                  ...
                  children: [
                    if (other != null && other['profilePicture'] != null)
                      ...
                      CircleAvatar(
                        ...
                        radius: 26,
                        child: Text(
                          (other?['fullName'] ?? '?').toString().substring(0, 1),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        if (other?['email'] != null)
                          Text(other?['email'], style: const TextStyle(fontSize: 14, color: Colors.grey)),
                        if (other?['phoneNumber'] != null)
                          Text(other?['phoneNumber'], style: const TextStyle(fontSize: 14, color: Colors.grey)),
                      ],
                    ),
                  ],
                ),
                ...
                child: Container(
                  ...
                  child: messages.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final ChatMessageModel msg = messages[messages.length - 1 - index];
                            final isMe = msg.sender.id == currentUserId;
                            print('[DEBUG] Message: sender=${msg.sender.fullName}, text=${msg.text}, isMe=$isMe');
                            return Align(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(fontSize: 10, color: isMe ? Colors.grey[200] : Colors.grey[600]),
                                    ),
                                  ],
                                ),
                              ),
...
class _ChatInputState extends State<_ChatInput> {
  ...
  void _send() {
    ...
    if (repo.socketDataSource.socket != null) {
      print('[DEBUG] Socket connected: ${repo.socketDataSource.socket!.connected}');
    } else {
      print('[DEBUG] Socket is null');
    }
    if (text.isNotEmpty) {
      widget.chatBloc.add(SendMessageEvent(chatId: widget.chatId, senderId: widget.currentUserId, text: text));
      _controller.clear();
    }
  }
