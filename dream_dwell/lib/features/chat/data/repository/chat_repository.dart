...
class ChatRepository {
  ...
  ChatRepository({required this.restDataSource, required this.socketDataSource});

  Future<Map<String, dynamic>> createOrGetChat({required String otherUserId, String? propertyId}) {
    print('[DEBUG] ChatRepository.createOrGetChat: otherUserId=$otherUserId, propertyId=$propertyId');
    return restDataSource.createOrGetChat(otherUserId: otherUserId, propertyId: propertyId);
  }
  ...
  void sendMessage(String chatId, String senderId, String text) {
    print('[DEBUG] ChatRepository.sendMessage: chatId=$chatId, senderId=$senderId, text=$text');
