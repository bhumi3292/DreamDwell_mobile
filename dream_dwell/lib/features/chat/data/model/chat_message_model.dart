...
import 'package:dream_dwell/features/chat/domain/entity/chat_message_entity.dart';
...
class ChatMessageModel extends Equatable {
  ...
  factory ChatMessageModel.fromEntity(ChatMessageEntity entity) => ChatMessageModel(
        id: entity.id,
...
class ChatSenderModel extends Equatable {
  ...
  factory ChatSenderModel.fromEntity(ChatSenderEntity entity) => ChatSenderModel(
        id: entity.id,
