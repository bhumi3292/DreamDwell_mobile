...
import 'package:dream_dwell/cores/network/hive_service.dart' as _i10;
...
class MockHiveService extends _i1.Mock implements _i10.HiveService {
  ...
  @override
  _i6.Future<void> registerUser(_i11.UserHiveModel? user) =>
      (super.noSuchMethod(
        Invocation.method(
          #registerUser,
          [user],
  ...
  @override
  _i6.Future<_i11.UserHiveModel?> loginUser(
    String? email,
    String? password,
  ) =>
      (super.noSuchMethod(
        ...
        returnValue: _i6.Future<_i11.UserHiveModel?>.value(),
      ) as _i6.Future<_i11.UserHiveModel?>);

  @override
  _i6.Future<List<_i11.UserHiveModel>> getAllUsers() => (super.noSuchMethod(
        Invocation.method(
          #getAllUsers,
          [],
        ),
        returnValue:
            _i6.Future<List<_i11.UserHiveModel>>.value(<_i11.UserHiveModel>[]),
      ) as _i6.Future<List<_i11.UserHiveModel>>);
  ...
  @override
  _i6.Future<_i11.UserHiveModel?> getCurrentUser() => (super.noSuchMethod(
        Invocation.method(
          #getCurrentUser,
          [],
        ),
  ...
  @override
  _i6.Future<void> addProperty(_i12.PropertyHiveModel? property) =>
      (super.noSuchMethod(
        Invocation.method(
          #addProperty,
          [property],
  ...
  @override
  _i6.Future<List<_i12.PropertyHiveModel>> getAllProperties() =>
      (super.noSuchMethod(
        Invocation.method(
          #getAllProperties,
          [],
        ),
        returnValue: _i6.Future<List<_i12.PropertyHiveModel>>.value(
            <_i12.PropertyHiveModel>[]),
      ) as _i6.Future<List<_i12.PropertyHiveModel>>);

  @override
  _i6.Future<void> updateProperty(_i12.PropertyHiveModel? property) =>
      (super.noSuchMethod(
        Invocation.method(
          #updateProperty,
          [property],
  ...
  @override
  _i6.Future<_i12.PropertyHiveModel?> getPropertyById(String? propertyId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getPropertyById,
          [propertyId],
        ),
        returnValue: _i6.Future<_i12.PropertyHiveModel?>.value(),
      ) as _i6.Future<_i12.PropertyHiveModel?>);

  @override
  _i6.Future<void> deletePropertyById(String? propertyId) =>
      (super.noSuchMethod(
        Invocation.method(
          #deletePropertyById,
          [propertyId],
  ...
  @override
  _i6.Future<void> addCategory(_i13.CategoryHiveModel? category) =>
      (super.noSuchMethod(
        Invocation.method(
          #addCategory,
          [category],
  ...
  @override
  _i6.Future<List<_i13.CategoryHiveModel>> getAllCategories() =>
      (super.noSuchMethod(
        Invocation.method(
          #getAllCategories,
          [],
        ),
        returnValue: _i6.Future<List<_i13.CategoryHiveModel>>.value(
            <_i13.CategoryHiveModel>[]),
      ) as _i6.Future<List<_i13.CategoryHiveModel>>);

  @override
  _i6.Future<void> updateCategory(_i13.CategoryHiveModel? category) =>
      (super.noSuchMethod(
        Invocation.method(
          #updateCategory,
          [category],
  ...
  @override
  _i6.Future<void> deleteCategoryById(String? categoryId) =>
      (super.noSuchMethod(
        Invocation.method(
          #deleteCategoryById,
          [categoryId],
